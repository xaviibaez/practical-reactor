...
public class c1_Introduction extends IntroductionBase {
    ...
    public void leaving_blocking_world_behind() throws InterruptedException {
        ...
        fortuneTop5()
                ...
                .collectList()
                .map(list -> setData(list, companyList, serviceCallCompleted))
                .subscribe()
        ;
    ...
    private List<String> setData(List<String> list, CopyOnWriteArrayList<String> companyList, AtomicReference<Boolean> serviceCallCompleted) {
